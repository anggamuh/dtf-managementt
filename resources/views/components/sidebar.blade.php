@php
    $nav = [
        ...
        'ledger.index' => ['label' => 'Buku Besar', 'icon' => 'o-book-open'],
    ...
    <div class="flex h-full flex-col lg:h-full">
        ...
        <div class="sidebar-header flex items-center justify-between px-4 py-4 h-16 flex-shrink-0">
            <a href="{{ route('dashboard') }}"
               class="flex items-center gap-2.5 overflow-hidden min-w-0">
                ...
                <div class="leading-tight whitespace-nowrap min-w-0 sidebar-logo-wrap">
                    <div class="sidebar-logo-text text-sm font-bold tracking-tight truncate">
                        DTF Management
                    </div>

                    <div class="sidebar-logo-sub text-[10px] font-medium uppercase tracking-widest truncate">
                        Printing Ops
                    </div>
                </div>
            </a>
            ...
            <button onclick="closeSidebar()"
                    ...
                    class="sidebar-close-btn rounded-lg p-1.5 transition lg:hidden flex-shrink-0">
        ...
        <nav class="flex-1 space-y-1 px-3 py-4 overflow-y-auto overflow-x-hidden">
            ...
            <div class="sidebar-section-label px-3 pb-2 text-[10px] font-semibold uppercase tracking-widest whitespace-nowrap">
                Menu Utama
            </div>
            ...
            @foreach($nav as $route => $item)
                ...
                @php
                    $isActive = match($route) {
                        ...
                        'orders.daily-summary' =>
                            $currentRoute === 'orders.daily-summary',
                        ...
                        */
                        ...
                        'materials.index' =>
                            str_starts_with($currentRoute, 'materials.'),

                        'ledger.index' =>
                            str_starts_with($currentRoute, 'ledger.'),

                        'closing.index' =>
                            str_starts_with($currentRoute, 'closing.'),
                    ...
                    $iconPath = match($item['icon']) {
                        ...
                        'o-document-text' =>
                            'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707l.001 10.999A2 2 0 0117 21z',
                        ...
                        'o-book-open' =>
                            'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5S19.832 5.477 21 6.253v13C19.832 18.477 18.246 18 16.5 18s-3.332.477-4.5 1.253',

                        'o-calculator' =>
                            'M9 7h6m-6 4h6m-6 4h6m-3-12v16m-7-4h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z',

                        'o-chart-bar' =>
                            'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',

                        'o-clipboard-document-check' =>
                            'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a3 3 0 006 0M9 5a3 3 0 016 0m-6 9l2 2 4-4',
                ...
                <a href="{{ route($route) }}"
                   ...
                   class="sidebar-tooltip-group relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 {{ $isActive ? 'sidebar-active' : '' }}">
                    ...
                    <span class="whitespace-nowrap sidebar-label">
                        {{ $item['label'] }}
                    </span>
        ...
        <div class="sidebar-footer p-3 flex-shrink-0">
            ...
            <div class="sidebar-profile flex items-center gap-3 rounded-xl p-2.5">
                ...
                <div class="min-w-0 overflow-hidden sidebar-profile-wrap">
                    ...
                    <div class="sidebar-profile-name text-sm font-semibold truncate">
                        {{ $user->name ?? 'User' }}
                    </div>

                    <div class="sidebar-profile-role text-xs truncate">
                        {{ $userRole ?: ($user->email ?? '') }}
                    </div>
