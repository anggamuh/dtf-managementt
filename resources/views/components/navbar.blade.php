<header class="sticky top-0 z-40 h-16 border-b border-[#E2E8F0] bg-white/90 backdrop-blur-xl dark:border-[#253247] dark:bg-[#0B1220]/90">
    <div class="flex h-full items-center justify-between px-4 lg:px-6">
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Notifications --}}
            <button aria-label="Notifikasi" class="relative h-10 w-10 rounded-xl border border-[#E2E8F0] bg-white hover:bg-slate-50 transition-all duration-200 flex items-center justify-center text-slate-600 hover:text-slate-800 dark:border-[#253247] dark:bg-[#111827] dark:text-slate-200 dark:hover:bg-[#172033]">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                </svg>
                <span class="absolute top-2 right-2 w-2 h-2 rounded-full bg-red-500 ring-2 ring-white dark:ring-slate-800"></span>
            </button>
